...
namespace AkberAli
{
    ...
    public partial class PurchaseReturn : Form
    {
        ...
        private void txtPieces1_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces2_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces3_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces4_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces5_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces6_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces7_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces8_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces9_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces10_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces11_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces12_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txtPieces1_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtPieces3_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txtPieces4_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txtPieces5_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txtPieces6_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txtPieces7_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txtPieces8_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txtPieces9_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txtPieces10_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txtPieces11_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txtPieces12_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtTotalPrice1.Text != "0" && txtTotalPrice1.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn ( Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory1.SelectedValue + "," +
                                                                                                                                                       txtProductCode1.Text + "," +
                                                                                                                                                       txtPieces1.Text + "," +
                                                                                                                                                       txtCartons1.Text + "," +
                                                                                                                                                       txtDis.Text + "," +
                ...
                if (txtTotalPrice2.Text != "" && txtTotalPrice2.Text != "0")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn (Category_ID, Product_ID, Qty_Pcs, Cartons,  Discount, Total_Amount, Date) values (" + cmbCategory2.SelectedValue + "," +
                                                                                                                                                                          txtProductCode2.Text + "," +
                                                                                                                                                                          txtPieces2.Text + "," +
                                                                                                                                                                          txtCartons2.Text + "," +
                                                                                                                                                                          txtDis.Text + "," +
                ...
                if (txtTotalPrice3.Text != "" && txtTotalPrice3.Text != "0")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn ( Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory3.SelectedValue + "," +
                                                                                                                                                                          txtProductCode3.Text + "," +
                                                                                                                                                                          txtPieces3.Text + "," +
                                                                                                                                                                          txtCartons3.Text + "," +
                                                                                                                                                                          txtDis.Text + "," +
                ...
                if (txtTotalPrice4.Text != "0" && txtTotalPrice4.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn (Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory4.SelectedValue + "," +
                                                                                                                                                                          txtProductCode4.Text + "," +
                                                                                                                                                                          txtPieces4.Text + "," +
                                                                                                                                                                          txtCartons4.Text + "," +
                                                                                                                                                                          txtDis.Text + "," +
                ...
                if (txtTotalPrice5.Text != "0" && txtTotalPrice5.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn (Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory5.SelectedValue + "," +
                                                                                                                                                                          txtProductCode5.Text + "," +
                                                                                                                                                                          txtPieces5.Text + "," +
                                                                                                                                                                          txtCartons5.Text + "," +
                                                                                                                                                                          txtDis.Text + "," +
                ...
                if (txtTotalPrice6.Text != "0" && txtTotalPrice6.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn ( Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory6.SelectedValue + "," +
                                                                                                                                                                          txtProductCode6.Text + "," +
                                                                                                                                                                          txtPieces6.Text + "," +
                                                                                                                                                                          txtCartons6.Text + "," +
                                                                                                                                                                          txtDis.Text + "," +
                ...
                if (txtTotalPrice7.Text != "0" && txtTotalPrice7.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn ( Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory7.SelectedValue + "," +
                                                                                                                                                                          txtProductCode7.Text + "," +
                                                                                                                                                                          txtPieces7.Text + "," +
                                                                                                                                                                          txtCartons7.Text + "," +
                                                                                                                                                                          txtDis.Text + "," +
                ...
                if (txtTotalPrice8.Text != "0" && txtTotalPrice8.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn (Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory8.SelectedValue + "," +
                                                                                                                                                                          txtProductCode8.Text + "," +
                                                                                                                                                                          txtPieces8.Text + "," +
                                                                                                                                                                          txtCartons8.Text + "," +
                                                                                                                                                                          txtDis.Text + "," +
                ...
                if (txtTotalPrice9.Text != "0" && txtTotalPrice9.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn (Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory9.SelectedValue + "," +
                                                                                                                                                                          txtProductCode9.Text + "," +
                                                                                                                                                                          txtPieces9.Text + "," +
                                                                                                                                                                          txtCartons9.Text + "," +
                                                                                                                                                                          txtDis.Text + "," +
                ...
                if (txtTotalPrice10.Text != "0" && txtTotalPrice10.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn (Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory10.SelectedValue + "," +
                                                                                                                                                      txtProductCode10.Text + "," +
                                                                                                                                                      txtPieces10.Text + "," +
                                                                                                                                                      txtCartons10.Text + "," +
                                                                                                                                                      txtDis.Text + "," +
                ...
                if (txtTotalPrice11.Text != "0" && txtTotalPrice11.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn (Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory11.SelectedValue + "," +
                                                                                                                                                  txtProductCode11.Text + "," +
                                                                                                                                                  txtPieces11.Text + "," +
                                                                                                                                                  txtCartons11.Text + "," +
                                                                                                                                                  txtDis.Text + "," +
                ...
                if (txtTotalPrice12.Text != "0" && txtTotalPrice12.Text != "")
                {
                    ...
                    String InsertQuery = "Insert into PurchaseReturn ( Category_ID, Product_ID, Qty_Pcs, Cartons, Discount, Total_Amount, Date) values (" + cmbCategory12.SelectedValue + "," +
                                                                                                                                                       txtProductCode12.Text + "," +
                                                                                                                                                       txtPieces12.Text + "," +
                                                                                                                                                       txtCartons12.Text + "," +
                                                                                                                                                       txtDis.Text + "," +
                ...
                MessageBox.Show("Purchases return have successfully saved.");
                refresh();
                PurchaseReturnView();
            }
            catch
            ...
            try
            {
                if (ID != null)
                {
                    ...
                    String updateQuery = "update inventory " +
                                          "set Quantity = Quantity + (select Qty_Pcs from PurchaseReturn where PurchaseReturn_ID = " + ID + ")" +
                                          "where Product_ID = (select Product_ID from PurchaseReturn where PurchaseReturn_ID = " + ID + ")";
                    ...
                    String DeleteQuery = "Delete from PurchaseReturn where PurchaseReturn_ID = " + ID;
                    SqlCommand cmdDelete = new SqlCommand(DeleteQuery, con);
                    con.Open();
                    cmdDelete.ExecuteNonQuery();
                    con.Close();
                    PurchaseReturnView();
                    MessageBox.Show("Purchase Return has successfully removed.");
                    ID = "";

                }
                else
                {
                    MessageBox.Show("Please select PurchaseReturn_ID");
                }
            }
            catch
            {
        ...
        String ID;
        private void gvPurchaseReturn_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ID = gvPurchaseReturn.Rows[e.RowIndex].Cells[0].Value.ToString();
        }
        public void PurchaseReturnView()
        {
            SqlDataAdapter da = new SqlDataAdapter("select PurchaseReturn_ID, c.Category_Name as Category, p.Product_Name as Product, " +
                                                        " pr.Qty_Pcs, pr.Cartons, pr.Discount, pr.Total_Amount, pr.date" +
                                                        " from PurchaseReturn pr " +
                                                        " join Category c on c.Category_ID = pr.Category_ID" +
                                                        " join Products p on p.Product_ID = pr.Product_ID" +
                                                        " where date = '" + TodayDate.GUID() + "'", con);
            DataTable dt = new DataTable();
            da.Fill(dt);

            gvPurchaseReturn.DataSource = dt;
        }
